...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("meridian", "Meridian menu — board, waiting items, activity, tickets", "Info",
               gateway_only=True, args_hint="[board|waiting|tickets|activity]",
               subcommands=("board", "waiting", "tickets", "activity")),
    CommandDef("meridian_status", "Compact Meridian role status (queue counts + who is doing what)", "Info",
               gateway_only=True),
    CommandDef("meridian_watch", "Start or inspect a live Meridian role log watch", "Info",
               gateway_only=True, args_hint="[philip|fatih|matthew|status]"),
    CommandDef("meridian_unwatch", "Stop one or all live Meridian role log watches", "Info",
               gateway_only=True, args_hint="[philip|fatih|matthew|all]"),
    CommandDef("meridian_reply", "Reply to a Meridian support ticket that is waiting on you", "Info",
               gateway_only=True, args_hint="[ticket_id] [message]"),
    CommandDef("meridian_ask", "Create a new Meridian support ticket for a role", "Info",
               gateway_only=True, args_hint="[philip|fatih|matthew] [message]"),
    CommandDef("meridian_task", "Inspect a Meridian workflow task, especially waiting_human items", "Info",
               gateway_only=True, args_hint="[task_id]"),
    CommandDef("meridian_cancel", "Cancel the active Meridian ask/reply/watch flow in this chat", "Info",
               gateway_only=True),

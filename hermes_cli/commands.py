...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("meridian", "Meridian role status, waiting items, and support tickets", "Info",
               gateway_only=True, args_hint="[status|waiting|tickets|board]",
               subcommands=("status", "waiting", "tickets", "board")),

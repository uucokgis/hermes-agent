...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("meridian_watch", "Start or inspect a live Meridian role log watch", "Info",
               gateway_only=True, args_hint="[planner|developer|reviewer|status]"),
    CommandDef("meridian_unwatch", "Stop one or all live Meridian role log watches", "Info",
               gateway_only=True, args_hint="[planner|developer|reviewer|all]"),
    ...
    CommandDef("meridian_ask", "Create a new Meridian support ticket", "Info",
